package org.example.day7.makingclass;
...
public class Television {
    ...
    public String size; //전역변수, 자동초기화, null로 초기화!
    public int price; // 전역변수, 기본형 변수
    public String company; //자료형 앞에 final을 붙이면 value고정 제조회사, 전역변수, 참조형변수, null로 초기화!
